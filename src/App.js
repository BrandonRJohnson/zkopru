    ...
    if ( item.withdrawal.status === 4 ) {
      return (
        <div className='table-row'>
            <div className="table-data-available" style={{ width: "8%", backgroundColor: "#EFF6FF" }}> Available </div>
            ...
            <div className="table-data" style={{ width: "15%", backgroundColor: "#EFF6FF"   }}>{newDate(item.expiration)}</div>
            ...
            <div className="table-data" style={{ width: "15%", backgroundColor: "#EFF6FF"   }}>{newDate(item.withdrawal.proposal.timestamp)}</div>
      ...
      return (
        <div className='table-row'>
            <div className="table-data" style={{ width: "8%" }}> Fulfilled </div>
            ...
            <div className="table-data" style={{ width: "15%" }}>{Date((item.expiration * 1000))}</div>
            ...
            <div className="table-data" style={{ width: "15%" }}>{Date((item.withdrawal.proposal.timestamp * 1000))}</div>
            <div className="table-data" style={{ width: "5%" }}>ETH</div>
            <div className="table-data" style={{ width: "5%" }}>{fromWei(item.prepayFeeInEth)} ETH</div>
        </div>
      )
    }
      ...
      return (
        <div className='table-row'>
            <div className="table-data" style={{ width: "8%" }}> Expired </div>
            <div className="table-data" style={{ width: "15%" }}>{fromWei((item.withdrawal.erc20Amount - item.prepayFeeInToken))} ETH</div>
            <div className="table-data" style={{ width: "15%" }}>TBD</div>
            <div className="table-data" style={{ width: "15%" }}>{Date((item.expiration * 1000))}</div>
            <div className="table-data" style={{ width: "8%" }}>{item.withdrawal.proposal.canonicalNum}</div>
    ...
    <div>
      ...
      <div className="table-container">
        <div className="table-header">
          ...
          <div style={{ width: "15%" }}>Creation</div>
          <div style={{ width: "5%" }}>Asset</div>
          <div style={{ width: "5%" }}>Amount</div>
        </div>
        {Data}
      </div>
    </div>
